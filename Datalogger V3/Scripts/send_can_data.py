...
while (True): #Sends logs
    ...
    #send x messages
    p = subprocess.Popen("cansend can0 477#" + m477, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
    p = subprocess.Popen("cansend can0 478#" + m478, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
    p = subprocess.Popen("cansend can0 479#" + m479, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
    p = subprocess.Popen("cansend can0 480#" + m480, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
    p = subprocess.Popen("cansend can0 475#" + m475, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
    p = subprocess.Popen("cansend can0 270#" + m270, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
    p = subprocess.Popen("cansend can0 294#" + m294, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
    p = subprocess.Popen("cansend can0 306#" + m306, cwd="/data/can-utils/", stdout=subprocess.PIPE, shell=True)
